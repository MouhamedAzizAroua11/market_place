<?php
    require_once "../app/action/Product/all.php";
?>
<script> 
    function del(id) 
    {
        ...
        if (result == true) 
        {
            window.location.assign("../app/action/Product/delete.php?id="+id);
        } 
        else 
        {
                           ...
                           <?php
                            while ($tab = $list->fetch(PDO::FETCH_ASSOC)) 
                            {
                                echo "<tr>";
                                    ...
                                    $id = $tab['id'];
                                    echo "<td><a href='mangement_product.php?page=update&id=".$id."'>Update</a></td>";
